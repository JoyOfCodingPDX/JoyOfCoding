...
public class AndroidZipFixerTest {
  ...
  public void manifestContainsSubmissionTime() {
    ...
    AndroidZipFixer fixer = new AndroidZipFixer(book);
    MatcherAssert.assertThat(fixer.getManifestEntriesForStudent(studentId).get(Submit.ManifestAttributes.SUBMISSION_TIME), equalTo(Submit.ManifestAttributes.formatSubmissionTime(submissionTime)));
  }
  ...
  public void manifestContainsLatestSubmissionTime() {
    ...
    AndroidZipFixer fixer = new AndroidZipFixer(book);
    MatcherAssert.assertThat(fixer.getManifestEntriesForStudent(studentId).get(Submit.ManifestAttributes.SUBMISSION_TIME), equalTo(Submit.ManifestAttributes.formatSubmissionTime(secondSubmissionTime)));
  }
  ...
  public void missingSubmissionDateResultsInNullManifestEntry() {
    ...
    AndroidZipFixer fixer = new AndroidZipFixer(book);
    assertThat(fixer.getManifestEntriesForStudent(studentId).get(Submit.ManifestAttributes.SUBMISSION_TIME), equalTo(null));
  }
