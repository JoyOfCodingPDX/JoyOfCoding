...
public class ProjectSubmissionsProcessorTest {
  ...
  private static class ManifestBuilder {
    ...
    private ManifestBuilder setProjectName(String projectName) {
      return setAttribute(Submit.ManifestAttributes.PROJECT_NAME, projectName);
    }
    ...
    private ManifestBuilder setStudentId(String studentId) {
      return setAttribute(Submit.ManifestAttributes.USER_ID, studentId);
    }

    public ManifestBuilder setStudentName(String studentName) {
      return setAttribute(Submit.ManifestAttributes.USER_NAME, studentName);
    }

    public ManifestBuilder setStudentEmail(String studentEmail) {
      return setAttribute(Submit.ManifestAttributes.USER_EMAIL, studentEmail);
    }
    ...
    private ManifestBuilder setSubmissionDate(String submissionDate) {
      return setAttribute(Submit.ManifestAttributes.SUBMISSION_TIME, submissionDate);
    }

    public ManifestBuilder setSubmissionComment(String submissionComment) {
      return setAttribute(Submit.ManifestAttributes.SUBMISSION_COMMENT, submissionComment);
    }

    public ManifestBuilder setEstimatedHours(Double estimatedHours) {
      return setAttribute(Submit.ManifestAttributes.ESTIMATED_HOURS, String.valueOf(estimatedHours));
    }
  }
